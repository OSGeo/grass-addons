...
# script to build GRASS GIS new current sources package from the `release_branch_8_5` branch
...
#   cd $HOME/src/release_branch_8_5/ && git pull && sudo apt install $(cat .github/workflows/apt.txt)
# - run this script
#
###################################################################
