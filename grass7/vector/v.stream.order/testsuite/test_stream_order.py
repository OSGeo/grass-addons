...
class TestStreamOrder(TestCase):
    ...
    def test_strahler(self):
        ...
        # feature 4
        self.assertEqual(v.read(4).attrs.cat, 38)
        ...
        self.assertEqual(v.read(4).attrs["strahler"], 1)
    ...
    def test_all(self):
        ...
        self.assertEqual(v.read(4).attrs["reversed"], 0)
        self.assertEqual(v.read(4).attrs["strahler"], 1)
        self.assertEqual(v.read(4).attrs["shreve"], 1)
        self.assertEqual(v.read(4).attrs["drwal"], 1)
        self.assertEqual(v.read(4).attrs["scheidegger"], 2)
        v.close()
        ...
        self.assertEqual(v.read(4).attrs["drwal"], 1)
        self.assertEqual(v.read(4).attrs["scheidegger"], 2)
        self.assertEqual(v.read(4).attrs["strahler_1"], 1)
        self.assertEqual(v.read(4).attrs["shreve_1"], 1)
        self.assertEqual(v.read(4).attrs["drwal_1"], 1)
        self.assertEqual(v.read(4).attrs["scheidegger_1"], 2)
        # feature 7
        ...
        self.assertEqual(v.read(7).attrs["strahler"], 3)
        self.assertEqual(v.read(7).attrs["strahler_1"], 3)
        self.assertEqual(v.read(7).attrs["shreve"], 5)
        self.assertEqual(v.read(7).attrs["drwal"], 3)
        self.assertEqual(v.read(7).attrs["scheidegger"], 10)
        v.close()
