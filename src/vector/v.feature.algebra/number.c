...
static NUMFUNC nf[] = {
    {"acos", acos, "d"},       {"asin", asin, "d"},   {"atan", atan, "d"},
    {"atan2", atan2, "dd"},    {"cos", cos, "d"},     {"sin", sin, "d"},
    {"tan", tan, "d"},         {"cosh", cosh, "d"},   {"sinh", sinh, "d"},
    {"tanh", tanh, "d"},       {"acosh", acosh, "d"}, {"asinh", asinh, "d"},
    {"atanh", atanh, "d"},     {"exp", exp, "d"},     {"frexp", frexp, "dai"},
    {"ldexp", ldexp, "di"},    {"ln", log, "d"},      {"log10", log10, "d"},
    {"modf", modf, "dai"},     {"pow", pow, "dd"},    {"sqrt", sqrt, "d"},
    {"hypot", hypot, "dd"},    {"cbrt", cbrt, "d"},   {"ceil", ceil, "d"},
    {"fabs", fabs, "d"},       {"floor", floor, "d"}, {"fmod", fmod, "dd"},
    {"drem", remainder, "dd"}, {"j0", j0, "d"},       {"j1", j1, "d"},
    {"jn", jn, "dd"},          {"y0", y0, "d"},       {"y1", y1, "d"},
    {"yn", yn, "dd"},          {"erf", erf, "d"},     {"erfc", erfc, "d"},
    {"lgamma", lgamma, "d"},   {"rint", rint, "d"},   {NULL, NULL, NULL}};
...
double numfunc(SYMBOL *func, SYMBOL *arglist)
{
    ...
    if (argc == 0 && (!func->proto || !*func->proto))
        ...
        res = (*(d_func_di)func->v.p)(arglist->v.d, (int)arglist->next->v.d);
        ...
        res = (*(d_func_ppp)func->v.p)(arglist->v.p, arglist->next->v.p,
