...
int print_stats(int order_max)
{
    ...
    fprintf(stdout, "Max order | Tot.N.str. | Tot.str.len. | Tot.area. | "
                    "Dr.dens. | Str.freq. \n");
    fprintf(stdout, "  (num)   |    (num)   |     (km)     |   (km2)   | "
                    "(km/km2) | (num/km2) \n");
    ...
    fprintf(stdout, " %7.4f | %7.4f | %8.4f | %7.4f | %7.4f\n",
            stats_total.reg_bifur_ratio, stats_total.reg_length_ratio,
            stats_total.reg_area_ratio, stats_total.reg_slope_ratio,
            stats_total.reg_gradient_ratio);
    fprintf(stdout, "\n");
    fprintf(stdout, "Averaged stream ratios with standard deviations:\n");
    fprintf(stdout, " Bif.rt. | Len.rt. | Area.rt. | Slo.rt. | Grd.rt. \n");
    fprintf(stdout, " %7.4f | %7.4f | %8.4f | %7.4f | %7.4f\n",
            stats_total.bifur_ratio, stats_total.length_ratio,
            stats_total.area_ratio, stats_total.slope_ratio,
            stats_total.gradient_ratio);

    fprintf(stdout, " %7.4f | %7.4f | %8.4f | %7.4f | %7.4f\n",
            stats_total.std_bifur_ratio, stats_total.std_length_ratio,
            stats_total.std_area_ratio, stats_total.std_slope_ratio,
    ...
    for (i = 1; i <= order_max; ++i) {
        fprintf(stdout, "%5d | %7.4f | %8.4f | %7.4f | %10.4f | %7.4f\n",
                ord_stats[i].order, ord_stats[i].avg_length / 1000,
                ord_stats[i].avg_area / 1000000, ord_stats[i].avg_slope,
    ...
    for (i = 1; i <= order_max; ++i) {
        fprintf(stdout, "%5d | %7.4f | %8.4f | %7.4f | %10.4f | %7.4f\n",
                ord_stats[i].order, ord_stats[i].std_length / 1000,
                ord_stats[i].std_area / 1000000, ord_stats[i].std_slope,
    ...
    for (i = 1; i <= order_max; ++i) {
        fprintf(stdout, "%5d | %9d | %12.4f | %7.4f\n", ord_stats[i].order,
                ord_stats[i].stream_num, ord_stats[i].sum_length / 1000,
                ord_stats[i].sum_area / 1000000);
    }
    /* order ratios */
    fprintf(stdout, "\n");
    fprintf(stdout, "Order | Bif.rt. | Len.rt. | Area.rt. | Slo.rt. | Grd.rt. "
                    "| d.dens. | str.freq.\n");
    for (i = 1; i <= order_max; ++i) {
        fprintf(stdout,
...
int print_stats_orders(int order_max)
{
    ...
    fprintf(stdout, "order,num_of_streams,avg_length,avg_area,avg_slope,avg_"
                    "grad,avg_elev.diff,sum_length,sum_area\n");

    for (i = 1; i <= order_max; ++i) {
        fprintf(stdout, "%d,%d,%f,%f,%f,%f,%f,%f,%f\n", ord_stats[i].order,
                ord_stats[i].stream_num, ord_stats[i].avg_length / 1000,
                ord_stats[i].avg_area / 1000000, ord_stats[i].avg_slope,
                ord_stats[i].avg_gradient, ord_stats[i].avg_elev_diff,
