...
the environmental variables (<i>NT2</i>: Type 2 novelty), which
...
<a href="https://grass.osgeo.org/grass64/manuals/g.region.html">region</a>
...
a mask, a set of layers describing current conditions (<b>reference</b>)
and a set of layers providing future conditions (<b>projection</b>). In
...
"https://www.climond.org/ExDet.aspx">https://www.climond.org/ExDet</a>.
...
<p>[2] ExDet: An stand alone extrapolation detection tool for the modelling of species distributions. URL: <a href="https://www.climond.org/ExDet.aspx">https://www.climond.org/ExDet.aspx</a>
