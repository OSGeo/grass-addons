...
<blockquote><i>
P<SUB>gshp</SUB>=8*(T<SUB>0</SUB> - T<SUB>lim</SUB>) &lambda; L t'<SUB>c</SUB>/(-0.619 t'<SUB>c</SUB>
log(u'<SUB>s</SUB>)-0.455 t'<SUB>c</SUB>-1.619+4 &pi; R<SUB>b</SUB>)</i><br>
<br>
where<blockquote>
T<SUB>0</SUB> is the undisturbed ground temperature (&deg;C),<br>
T<SUB>lim</SUB> the threshold temperature of the heat carrier
fluid setting to 2&deg;C,<br>
&lambda; is the  the
...
Energy 106, p 765 -- <br>
<a href="https://doi.org/10.1016/j.energy.2016.03.091">https://doi.org/10.1016/j.energy.2016.03.091</a><br>
