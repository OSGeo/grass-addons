...
def general(
    ...
    Module(
        "r.mapcalc",
        expression="zzazimuth = (450-zzaspect) - int( (450-zzaspect) / 360) * 360",
        quiet=True,
    )
    ...
    try:
        ...
        if obsabselev:
            ...
            if downward:
                ...
                Module(
                    "r.mapcalc",
                    expression="zzview{I} = if(zzview{I}>90 && zzview{I}<180,null(),zzview{I})".format(
                        I=i
                    ),
                    overwrite=True,
                    quiet=True,
        ...
        Module(
            "r.mapcalc",
            expression="zzview{I} = if(zzview{I}==180,0,zzview{I})".format(I=i),
            overwrite=True,
            quiet=True,
        )
        ...
        Module(
            "r.mapcalc",
            expression="zzview90_{I} = zzview{I} - 90".format(I=i),
            quiet=True,
        )
        # evaluate the vertical component of the versor oriented along the line of sight
        Module(
            "r.mapcalc",
            expression="zzc_view{I} = sin(zzview90_{I})".format(I=i),
            quiet=True,
        )
        # evaluate the northern component of the versor oriented along the line of sight
        Module(
            "r.mapcalc",
            expression="zzb_view{I} = cos(zzview90_{I})*cos(zzview_angle{I})".format(
                I=i
            ),
            quiet=True,
        )
        ...
        Module(
            "r.mapcalc",
            expression="zza_view{I} = cos(zzview90_{I})*sin(zzview_angle{I})".format(
                I=i
            ),
            quiet=True,
        )
        ...
        if obsabselev:
            if hcurv:
                ...
                eradius = kvj[
                    "+a"
                ]  # This is the radius of the earth for the elipsoid in the current projection
                Module(
                    "r.mapcalc",
        ...
        if hcurv:
            ...
            Module(
                "r.mapcalc",
                expression="kkview_angle{I} = if(y()>{py} && x()>={px}, zzview_angle{I}+270, zzview_angle{I}-90)".format(
                    I=i, py=y, px=x
                ),
                quiet=True,
            )
            ...
            Module(
                "r.mapcalc",
                expression="kkb_view{I} = cos(kkview_angle{I})".format(I=i),
                quiet=True,
            )
            Module(
                "r.mapcalc",
                expression="kka_view{I} = sin(kkview_angle{I})".format(I=i),
                quiet=True,
            )
            ...
            Module(
                "r.mapcalc",
                expression="zz_dotproduct{I} = kka_view{I}*zza_dem + kkb_view{I}*zzb_dem + kkc_view{I}*zzc_dem".format(
                    I=i
                ),
                quiet=True,
            )
            ...
            Module(
                "r.mapcalc",
                expression="zzc_dem_curv{I} = zzc_equation_first{I} + zzc_equation_second{I} + zzc_equation_third{I}".format(
                    I=i
                ),
                quiet=True,
            )
            Module(
                "r.mapcalc",
                expression="zzb_dem_curv{I} = zzb_equation_first{I} + zzb_equation_second{I} + zzb_equation_third{I}".format(
                    I=i
                ),
                quiet=True,
            )
            Module(
                "r.mapcalc",
                expression="zza_dem_curv{I} = zza_equation_first{I} + zza_equation_second{I} + zza_equation_third{I}".format(
                    I=i
                ),
                quiet=True,
            )
            ...
            Module(
                "r.mapcalc",
                expression="zzangle{I} = acos((zza_view{I}*zza_dem_curv{I}+zzb_view{I}*zzb_dem_curv{I}+zzc_view{I}*zzc_dem_curv{I})/(sqrt(zza_view{I}*zza_view{I}+zzb_view{I}*zzb_view{I}+zzc_view{I}*zzc_view{I})*sqrt(zza_dem_curv{I}*zza_dem_curv{I}+zzb_dem_curv{I}*zzb_dem_curv{I}+zzc_dem_curv{I}*zzc_dem_curv{I})))".format(
                    I=i
                ),
                quiet=True,
            )
            ...
            Module(
                "r.mapcalc",
                expression="zzangle{I} = acos((zza_view{I}*zza_dem+zzb_view{I}*zzb_dem+zzc_view{I}*zzc_dem)/(sqrt(zza_view{I}*zza_view{I}+zzb_view{I}*zzb_view{I}+zzc_view{I}*zzc_view{I})*sqrt(zza_dem*zza_dem+zzb_dem*zzb_dem+zzc_dem*zzc_dem)))".format(
                    I=i
                ),
                quiet=True,
            )
        ...
        Module(
            "r.mapcalc",
            expression="zzsangle{I} = if(zzsangle{I}>2*{pi} || zzB2_{I}>=90,2*{pi},zzsangle{I})".format(
                I=i, pi=pi
            ),
            overwrite=True,
            quiet=True,
