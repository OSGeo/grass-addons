...
Tool *r.futures.pga* was renamed to
*[r.futures.simulation](r.futures.simulation.md)*. This tool is only a
wrapper for *r.futures.simulation* to keep backwards compatibility.
