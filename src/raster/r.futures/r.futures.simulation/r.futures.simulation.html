<h2>DESCRIPTION</h2>
Module <em><a href="r.futures.pga.html">r.futures.pga</a></em> will be renamed to <em>r.futures.simulation</em>.
This module is only a wrapper for <em>r.futures.pga</em> for forward compatibility.
