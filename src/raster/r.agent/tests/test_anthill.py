...
class TestAnthill(unittest.TestCase):
    ...
    def test_getpheromone(self):
        self.assertNotEqual(
            9, self.world.playground.layers[anthill.Anthill.RESULT][0][0]
        )
    ...
    def test_setpheromone(self):
        ...
        self.assertNotEqual(
            4, self.world.playground.layers[anthill.Anthill.RESULT][0][0]
        )
        self.world.setpheromone([0, 0], 4)
        self.assertNotEqual(
            5, self.world.playground.layers[anthill.Anthill.RESULT][0][0]
        )
        self.assertEqual(4, self.world.playground.layers[anthill.Anthill.RESULT][0][0])

    def test_setsteppheromone(self):
        self.world.setpheromone([0, 0], 0)
        self.assertNotEqual(self.world.stepintensity, self.world.getpheromone([0, 0]))
        self.world.setsteppheromone([0, 0])
        self.assertEqual(self.world.stepintensity, self.world.getpheromone([0, 0]))

    def test_setpathpheromone(self):
        self.world.setpheromone([0, 0], 0)
        self.assertNotEqual(self.world.pathintensity, self.world.getpheromone([0, 0]))
        self.world.setpathpheromone([0, 0])
        self.assertEqual(self.world.pathintensity, self.world.getpheromone([0, 0]))

    def test_getpenalty(self):
        self.assertNotEqual(9, self.world.playground.layers[anthill.Anthill.COST][0][0])
        self.world.playground.layers[anthill.Anthill.COST][0][0] = 9
        self.assertEqual(9, self.world.getpenalty([0, 0]))

    def test_getpenalty(self):
        self.assertNotEqual(9, self.world.playground.layers[anthill.Anthill.SITE][0][0])
