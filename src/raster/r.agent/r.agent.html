<!-- meta page name: r.agent -->
<!-- meta page name description: Toolset for agent based modeling -->
...
<ul>
<li><a href="r.agent.aco.html">r.agent.aco</a>:
Agents wander around on the terrain, marking paths to new locations.</li>
<li><a href="r.agent.rand.html">r.agent.rand</a>:
Agents wander around on the terrain, marking paths to new locations.</li>
</ul>
