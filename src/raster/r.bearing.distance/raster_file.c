...
void Set_buffer_null_c_row_col(void *out_buf, RASTER_MAP_TYPE out_buf_type,
                               int row, int col)
{
    void *ptr;
...
void Set_buffer_null_d_row_col(void *out_buf, RASTER_MAP_TYPE out_buf_type,
                               int row, int col)
{
    void *ptr;
...
void Set_buffer_null_f_row_col(void *out_buf, RASTER_MAP_TYPE out_buf_type,
                               int row, int col)
{
    void *ptr;
