...
int searching_parallel(double *length,
                       ...
                       double *sunVarGeom_z_orig, double *sunVarGeom_zmax,
...
double drad_parallel(double sh, double bh, double *rr,
                     ...
                     int *sunVarGeom_isShadow, double *sunVarGeom_solarAltitude,
                     double *sunVarGeom_sinSolarAltitude,
...
void com_par_parallel(double *sunGeom_lum_C11, double *sunGeom_lum_C13,
                      double *sunGeom_lum_C22, double *sunGeom_lum_C31,
                      double *sunGeom_lum_C33, double *sunGeom_sunrise_time,
                      double *sunGeom_sunset_time, double *sunGeom_timeAngle,
...
double lumcline2_parallel(
    ...
    int *sunVarGeom_isShadow, double *sunVarGeom_solarAltitude,
    double *sunVarGeom_sunAzimuthAngle, double *sunVarGeom_z_orig,
    double *sunVarGeom_zmax, double *sunVarGeom_zp,
    double *sunVarGeom_tanSolarAltitude, double *sunVarGeom_stepsinangle,
    double *sunVarGeom_stepcosangle,

    double *sunSlopeGeom_longit_l, double *sunSlopeGeom_lum_C31_l,
