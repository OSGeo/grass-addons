...
void user_input(int argc, char **argv)
{
    ...
    diversity->key = "div";
    diversity->description = "d1 = richness      d2 = Shannon     d3 = "
                             "dominance     d4 = inv. Simpson";
    ...
    measure_code->description =
        ...
        "\tt1 = contagion           t2 = ang. sec. mom.     t3 = inv. diff. "
        "mom.\n"
    ...
    edge->key = "edg";
    edge->description = "e1 = sum of edges  e2 = sum of edges by type (need "
                        "edge file: r.le.para)";
    edge->options = "e1,e2";
