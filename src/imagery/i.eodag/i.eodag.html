...
past 60 days. Note that the dates used for searching <b>start</b>, <b>end</b>,
in addition to <b>ingestiondate</b>, which is displayed when listing found scenes,
refer to the sensing time of the scene.
