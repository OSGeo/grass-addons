...
_lib.retrieve_aod_maiac(
    _fp(aod_2d), ctypes.c_int(32), ctypes.c_int(32), ctypes.c_int(8)
)
...
_lib.oe_invert_aod_h2o.argtypes = [
    ...
    _FP,
    ctypes.c_int,
    ctypes.c_int,  # rho_toa_vis, npix, n_vis
    _FP,  # vis_wl
    _FP,
    _FP,
    _FP,  # L_865, L_940, L_1040
    ctypes.c_float,
    ctypes.c_float,  # sza, vza
    ctypes.c_float,
    ctypes.c_float,  # aod_prior, h2o_prior
    ctypes.c_float,
    ctypes.c_float,
    ctypes.c_float,  # sigma_aod, _h2o, _spec
...
_lib.oe_invert_aod_h2o(
    ...
    ctypes.c_float(sza),
    ctypes.c_float(vza),
    ctypes.c_float(float(aod_scene)),
    ctypes.c_float(float(wvc.mean())),
    ctypes.c_float(0.5),
    ctypes.c_float(1.0),
    ctypes.c_float(0.01),
    ctypes.c_float(0.0),
...
print(
    f"OE retrieval: mean AOD = {out_aod.mean():.3f}  "
