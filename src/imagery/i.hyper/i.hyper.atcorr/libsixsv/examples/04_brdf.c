...
int main(void)
{
    ...
    float rho_hapke =
        sixs_brdf_eval(BRDF_HAPKE, &hapke, cos_sza, cos_vza, raa_deg);
    printf("Hapke:     rho = %.4f\n", rho_hapke);
    ...
    float rho_nbar = atcorr_brdf_normalize(
        rho_boa, rl.rosslimaignan.f_iso, rl.rosslimaignan.f_vol,
        rl.rosslimaignan.f_geo, sza_obs, vza_obs, raa_obs, sza_nbar);
