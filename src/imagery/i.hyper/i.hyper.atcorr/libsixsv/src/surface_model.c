...
static const float REF_WL[SM_N_REF] = {
    0.400f, 0.450f, 0.500f, 0.550f, 0.600f, 0.650f, 0.680f, 0.700f,
    0.720f, 0.750f, 0.800f, 0.850f, 0.900f, 1.000f, 1.100f, 1.200f,
    1.300f, 1.400f, 1.500f, 1.600f, 1.700f, 1.800f, 1.900f, 2.000f,
    2.100f, 2.200f, 2.300f, 2.400f, 2.500f};

/* Component 0: Typical green vegetation */
static const float VEG_REFL[SM_N_REF] = {
    0.030f, 0.040f, 0.050f, 0.080f, 0.050f, 0.040f, 0.030f, 0.080f,
    0.200f, 0.400f, 0.430f, 0.450f, 0.440f, 0.420f, 0.400f, 0.380f,
    0.350f, 0.100f, 0.300f, 0.280f, 0.250f, 0.100f, 0.050f, 0.200f,
    0.220f, 0.180f, 0.120f, 0.080f, 0.050f};

/* Component 1: Bare soil / mixed bare surfaces */
static const float SOIL_REFL[SM_N_REF] = {
    0.040f, 0.050f, 0.070f, 0.100f, 0.130f, 0.160f, 0.180f, 0.190f,
    0.200f, 0.210f, 0.220f, 0.240f, 0.250f, 0.270f, 0.280f, 0.300f,
    0.310f, 0.150f, 0.300f, 0.320f, 0.330f, 0.150f, 0.100f, 0.300f,
    0.310f, 0.280f, 0.220f, 0.180f, 0.150f};

/* Component 2: Water / wet surfaces */
static const float WATER_REFL[SM_N_REF] = {
    0.050f, 0.060f, 0.060f, 0.050f, 0.040f, 0.030f, 0.030f, 0.020f,
    0.020f, 0.020f, 0.010f, 0.010f, 0.010f, 0.010f, 0.005f, 0.005f,
...
static const float *REFL_TABLE[SM_N_COMPONENTS] = {VEG_REFL, SOIL_REFL,
                                                   WATER_REFL};
...
/**
 * \brief Linear interpolation of a 1-D tabulated function with clamp
 * extrapolation.
 ...
 * \return Pointer to the new \c SurfaceModelImpl, or NULL on allocation
 * failure. Free with surface_model_free().
 */
 ...
 * \param[in,out] refl_cube  Reflectance cube [n_bands × npix] (modified in
 * place).
...
#define SM_MAX_BANDS 2048
    if (n_bands > SM_MAX_BANDS)
        n_bands = SM_MAX_BANDS;
...
/**
 * \brief Compute the per-band surface model discrepancy (empirical RT error
 * floor).
 *
 ...
 * The values are calibrated to match the Python \c lib/uncertainty.py
 * reference.
 *
 * \param[in]  wl_um     Wavelength grid in µm (length \c n_wl).
 * \param[in]  n_wl      Number of bands.
 * \param[out] sigma_out Per-band standard deviation of model discrepancy
 * [n_wl].
 */
void surface_model_discrepancy(const float *wl_um, int n_wl, float *sigma_out)
{
    ...
    static const float centers[6] = {0.720f, 0.760f, 0.940f,
                                     1.135f, 1.380f, 1.850f};
