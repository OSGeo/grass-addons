...
class TestClimatologies(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.runModule("t.register",  flags="i",  type="raster",  input="daily",
                      ...
                      start="2001-02-01", increment="1 day",  overwrite=True)
        cls.runModule("t.register",  flags="i",  type="raster",  input="daily",
        ...
        cls.runModule("t.register",  flags="i",  type="raster",  input="daily",
                      ...
                      start="2002-02-01", increment="1 day",  overwrite=True)
    ...
    def test_1(self):
        ...
        self.assertModule("t.rast.climatologies",  input="daily",
                          output="monthly_clima", method="average",
                          basename="monthly_avg", granularity="monthly",
