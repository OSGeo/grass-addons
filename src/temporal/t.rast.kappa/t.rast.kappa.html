...
by <a href="https://grass.osgeo.org/grass-stable/manuals/r.kappa.html">r.kappa</a> and the one provided by
<a href="https://scikit-learn.org/stable/modules/generated/sklearn.metrics.cohen_kappa_score.html">SciKit-Learn metrics</a> library

<h2>EXAMPLE</h2>

<h3>Using r.kappa as backend</h3>
In this example t.rast.kappa is using <a href="https://grass.osgeo.org/grass-stable/manuals/r.kappa.html">r.kappa</a> as backend,
it return the results inside the <em>/tmp</em>em> directory into files with <em>mystrds</em> as prefix.
<em>weight</em> option is not considered using <a href="https://grass.osgeo.org/grass-stable/manuals/r.kappa.html">r.kappa</a> as backend.
<div class="code">
    <pre>
...
<a href="https://scikit-learn.org/stable/modules/generated/sklearn.metrics.cohen_kappa_score.html" target="_blank">SciKit-Learn metrics</a>
