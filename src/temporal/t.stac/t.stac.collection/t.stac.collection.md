...
<em>t.stac.collection</em> is a tool for exploring SpatioTemporal Asset Catalog (STAC) collection metadata.
...
<a href="https://grass.osgeo.org/grass-stable/manuals/t.stac.item.html">t.stac.item</a>,
</em>
