...
/* multiply two matrices, initialize the dimensions of res
 * to correct values. Return 1 on success, 0 on failure.
 * return value 0 means - bad dimensions or out of memory */
