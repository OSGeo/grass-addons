...
pscp.exe -r -i .\ssh\id_dsa.ppk .\grass64\addons\*.zip .\grass64\addons\*.md5sum landa@geo102:/work/wingrass/grass65/addons
pscp.exe -r -i .\ssh\id_dsa.ppk .\grass64\addons\log                             landa@geo102:/work/wingrass/grass65/addons
pscp.exe -r -i .\ssh\id_dsa.ppk .\grass65\addons\*.zip .\grass65\addons\*.md5sum landa@geo102:/work/wingrass/grass65/addons
pscp.exe -r -i .\ssh\id_dsa.ppk .\grass65\addons\log                             landa@geo102:/work/wingrass/grass65/addons
pscp.exe -r -i .\ssh\id_dsa.ppk .\grass70\addons\*.zip .\grass70\addons\*.md5sum landa@geo102:/work/wingrass/grass70/addons
pscp.exe -r -i .\ssh\id_dsa.ppk .\grass70\addons\log                             landa@geo102:/work/wingrass/grass70/addons
